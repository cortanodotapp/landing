...
interface CortanoWelcomeEmailProps {
  steps: {
    id: number;
...
export const CortanoWelcomeEmail = ({
  steps,
  links,
  locale = 'en',
  unsubscribeToken,
  email,
  translations,
}: CortanoWelcomeEmailProps) => {
  // Default English translations
  const defaultTranslations = {
    preview: 'Welcome to Cortano - Your AI Call Agent Platform',
    welcome: 'Welcome to Cortano',
    ...
    companyInfo: 'Cortano, London, United Kingdom',
    steps: {
      productUpdates: {
...
CortanoWelcomeEmail.PreviewProps = {
  ...
  locale: 'en',
} satisfies CortanoWelcomeEmailProps;

export default CortanoWelcomeEmail;
